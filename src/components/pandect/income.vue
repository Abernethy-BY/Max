 ...
 * @LastEditTime: 2022-08-19 15:26:28
 * @LastEditors: By
 * @Description:
 * @FilePath: \big-screen-vue3\src\components\income.vue
...
//         if (u > Math.PI * 2.5) { return Math.sin(u) * (h * 10) * .1; }
...
//               res = pieData[i].name + this.data[i].number;
//             }
//           }
//           if (!res) {
//             res = value;
