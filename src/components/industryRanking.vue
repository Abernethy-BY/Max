 ...
 * @LastEditTime: 2022-08-18 22:29:08
 * @LastEditors: By
 * @Description:
 * @FilePath: \big-screen-vue3\src\components\industryRanking.vue
...
export default {
  ...
  watch: {
    industryRankingProp() { this.initIndustryEankingRefChart() },
  },
  methods: {
...
.industry-ranking-box {
  ...
  background-image: url("~@/views/pandect/assets/industryRankingBg.png");
